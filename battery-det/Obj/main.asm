...
;Line#62 		fcout1++;
 	...
 	;ADDU1 _fcout1 ,_fcout1 ,#1
	__SelectBANK _fcout1
	INCMS _fcout1
	NOP
...
L28:
;Line#73  	long int temp_bat = 0x0000;

 	;MOVI2 _main_data@0 ,#0
...
L35:
;Line#86 		_ClearWatchDogTimer();

 	;CALLV __ClearWatchDogTimer
	CALL __ClearWatchDogTimer
.stabn 0x44,0,89,L36-_main
L36:
;Line#89 		if (fcout1 == 60) {
...
;Line#91 			fcout2++;
 	...
 	;ADDU1 _fcout2 ,_fcout2 ,#1
	__SelectBANK _fcout2
	INCMS _fcout2
	NOP
...
L52:
;Line#103 				controlLED(4096);

 	;PUSH _controlLED_arg@0 ,#4096
	__SelectBANK _controlLED_arg@0
...
L55:
;Line#105 			} else { //According to AD value set LED When BAT_IN detect
...
L58:
;Line#106 				temp_bat = getBAT_AD();

 	;CALLI2 _main_data@0 ,_getBAT_AD
	CALL _getBAT_AD
	__SelectBANK _main_data@0
	MOV _main_data@0, A
	B0MOV A, R
...
L59:
;Line#107 				controlLED(temp_bat);

 	;PUSH _controlLED_arg@0 ,_main_data@0
	MOV A, _main_data@0
	__SelectBANK _controlLED_arg@0
...
L80:
;Line#138 	FTC0ENB = 1;			/*only use TC0*/

 	;MOVX1 0xDA.7 ,#1
	B0BSET 0xDA.7
.stabn 0x44,0,139,L81-_initTimer
L81:
;Line#139 	FGIE = 1;				/*enable interrupt*/
...
L110:
;Line#174 		bat_in_cnt = 0;

 	;MOVU1 _bat_in_cnt ,#0
	__SelectBANK _bat_in_cnt
	CLR _bat_in_cnt
.stabn 0x44,0,175,L111-_dc_DET
L111:
;Line#175 		dc_in_cnt++;

 	;ADDU1 _dc_in_cnt ,_dc_in_cnt ,#1
	__SelectBANK _dc_in_cnt
	INCMS _dc_in_cnt
	NOP
.stabn 0x44,0,176,L112-_dc_DET
L112:
;Line#176 		if (dc_in_cnt == DC_DEBOUNCING_TIMES){

 	;NEI1 L98 ,_dc_in_cnt ,#8
	MOV A, _dc_in_cnt
	CMPRS A, #0x08
	JMP L98
...
L115:
;Line#177 			dc_in_cnt = 0;

 	;MOVU1 _dc_in_cnt ,#0
	CLR _dc_in_cnt
.stabn 0x44,0,178,L116-_dc_DET
L116:
;Line#178 			dc_type = DC_IN;
...
L120:
;Line#180 	} else {//BAT IN when high level detected
...
;Line#182 		bat_in_cnt++;
 	...
 	;ADDU1 _bat_in_cnt ,_bat_in_cnt ,#1
	__SelectBANK _bat_in_cnt
	INCMS _bat_in_cnt
	NOP
.stabn 0x44,0,183,L125-_dc_DET
L125:
;Line#183 		if (bat_in_cnt == DC_DEBOUNCING_TIMES){

 	;NEI1 L98 ,_bat_in_cnt ,#8
	MOV A, _bat_in_cnt
	CMPRS A, #0x08
	JMP L98
...
L128:
;Line#184 			bat_in_cnt = 0;

 	;MOVU1 _bat_in_cnt ,#0
	CLR _bat_in_cnt
.stabn 0x44,0,185,L129-_dc_DET
L129:
;Line#185 			dc_type = BAT_IN;
